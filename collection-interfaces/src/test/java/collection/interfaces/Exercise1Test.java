...
public class Exercise1Test extends ClassicOnlineStore {
    ...
    public void whoHaveNoEInYourName() {
         ...
         */
        Predicate<String> predicate = input -> input.contains("e");
    ...
    public void replaceTheElements() {
         ...
         */
        UnaryOperator<String> unaryOperator = input -> "(" + input + ")";
    ...
    public void sortByName() {
         ...
         */
        Comparator<String> comparator = (string1, string2) -> string1.length() - string2.length();
